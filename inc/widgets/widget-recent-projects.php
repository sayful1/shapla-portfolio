<?php
add_action('widgets_init', create_function('', 'return register_widget("shapla_portfolio_widget_recent_projects");'));
    ...
    function widget($args, $instance){
        ...
        if($button_link != ''){
          ...
          <div class="text-center section-cta">
          	<a href="<?php echo esc_url( $button_link ); ?>" class="btn btn-primary btn-lg"><?php echo esc_attr( $button_text ); ?></a>
          </div>
          </div></div>
          <?php
        }
