<?php
add_action('widgets_init', create_function('', 'return register_widget("shapla_portfolio_widget_slide");'));
...
class shapla_portfolio_widget_slide extends WP_Widget{
    ...
    function widget($args, $instance){
        ...
        $slide_id       = (isset($instance['slide_id'])) ? $instance['slide_id'] : '';
        $slide_width    = (isset($instance['slide_width'])) ? $instance['slide_width'] : '';
    ...
    function form($instance){
        ...
        <p>
            ...
            <input type="text" class="widefat" id="<?php echo $this->get_field_id( 'slide_id' ); ?>" name="<?php echo $this->get_field_name( 'slide_id' ); ?>" value="<?php echo $instance['slide_id']; ?>">
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('slide_width'); ?>">
                <input type="checkbox" name="<?php echo $this->get_field_name( 'slide_width' ); ?>" id="<?php echo $this->get_field_id( 'slide_width' ); ?>" value="on" <?php checked( $instance['slide_width'], 'on' ); ?>>
