<?php
add_action('widgets_init', create_function('', 'return register_widget("shapla_portfolio_widget_contact");'));
...
class shapla_portfolio_widget_contact extends WP_Widget{
    ...
    <p>
        <label for="<?php echo $this->get_field_id('contact_form'); ?>"><?php _e('Show contact form', 'shapla-portfolio'); ?>
            <input type="checkbox" id="<?php echo $this->get_field_id( 'contact_form' ); ?>" name="<?php echo $this->get_field_name( 'contact_form' ); ?>" value="on" <?php checked( $instance['contact_form'], 'on' ); ?>>
        </label>
