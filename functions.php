...
function shapla_portfolio_scripts() {
	...
	if ( !is_shaplatools_activated() ) {
		...
		wp_register_script( 'shuffle', get_template_directory_uri(). '/assets/shuffle/jquery.shuffle.min.js', array( 'jquery', 'modernizr' ), '3.2', true );

	}
	wp_register_script( 'shuffle-custom', get_template_directory_uri(). '/assets/shuffle/shuffle-custom.js', array( 'jquery', 'shuffle' ), '3.2', true );
 ...
 */
function shapla_portfolio_excerpt_more( $more ) {
